void getNLL(TString fitresult, TString sysname, TString type){
...
//void getNLL(TString fitresult = "outLL_allSys"){
  ...
  TFile *f_SM = new TFile(fitresult+"/out_m00_"+sysname+"_"+type+".root", "read");
  ...
  //for(auto d = cHWs.begin(); d != cHWs.end(); d++){
    TFile *f = new TFile(fitresult+"/out_"+d->first+"_"+sysname+"_"+type+".root", "read");
